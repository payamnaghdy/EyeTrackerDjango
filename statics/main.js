...
let data_iterator = 0;
function captureExample(interval,l,t){
  ...
  move_interval = setInterval(moveCircle, 400, move_interval);

}
function moveCircle(interval){
  if(data_iterator == data_positions){
    clearInterval(interval);

  }
  clearInterval(interval);
  captureExample_interval = setInterval(captureExample, 300, captureExample_interval,data_positions[data_iterator].x,data_positions[data_iterator].y);
